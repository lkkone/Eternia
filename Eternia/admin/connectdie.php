...
<head>
    ...
    <meta content="Eternia" name="description"/>
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-0 text-center">
                            <a href="https://blog.likaikai.com" target="_blank" rel="noopener noreferrer">
                                <button
                                        class="btn btn-primary" type="button"> 配置教程
                                </button>
                            </a>
                            <div class="mar_top">
                                <a href="../admin">
                                    <button
                                            class="btn btn-success" type="button"> 已配置成功点我跳转登录
                                    </button>
                                </a>
                            </div>
                        </div>
...
<footer class="footer footer-alt">
    Copyright © 2022 Likaikai && <a href="#" target="_blank">Eternia</a> All
    Rights Reserved.
</footer>

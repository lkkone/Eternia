            ...
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" novalidate>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <?php if (password_verify($adminpw, $login['pw']))  {?><span class="badge badge-danger-lighten"style="font-size: 0.8rem;">您的密码为默认密码 请尽快修改</span><?php }else{ ?> <span class="badge badge-success-lighten"style="font-size: 0.8rem;">密码由大小写字母与数字组成</span> <?php } ?>

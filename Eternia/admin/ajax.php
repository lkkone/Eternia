...
<script>
    $("#userPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 135) {
                    toastr["success"]("更新登录信息成功！", "Eternia");
                    toastr["success"]("更新全局信息成功", "Eternia");
                    toastr["success"]("更新自定义内容成功", "Eternia");
                } else if (res == 046) {
                    toastr["error"]("更新登录信息失败！", "Eternia");
                    toastr["error"]("更新全局信息失败！", "Eternia");
                    toastr["error"]("更新自定义内容失败！", "Eternia");
                } else if (res == 7) {
                    toastr["error"]("安全码错误！", "Eternia");
                } else if (res == 8) {
                    toastr["error"]("用户名含有特殊字符，修改已拦截！", "Eternia");
                } else if (res == 9) {
                    toastr["error"]("密码长度需大于6位！", "Eternia");
                } else if (res == 10) {
                    toastr["error"]("密码含有特殊字符，请使用字母和数字组合！", "Eternia");
                } else if (res == 11) {
                    toastr["error"]("密码格式不正确，只支持字母和数字！", "Eternia");
                } else {
                    toastr["error"]("未知错误！返回码: " + res, "Eternia");
                }
            },
            error: function (err) {
    ...
    $("#adminPost").click(function () {
        ...
        var headerBarShow = $("select[name='headerBarShow']").val();
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 13) {
                    toastr["success"]("基本信息修改成功！", "Eternia");
                    toastr["success"]("开关设置成功！", "Eternia");
                } else if (res == 04) {
                    toastr["error"]("基本信息修改失败！", "Eternia");
                    toastr["error"]("开关设置修改失败！", "Eternia");
                } else {
    ...
    $("#loveadminPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("情侣信息修改成功！", "Eternia");
                } else if (res == 0) {
                    toastr["error"]("情侣信息修改失败！", "Eternia");
                } else if (res == 3) {
                    toastr["error"]("QQ号码格式错误！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");
    ...
    $("#CardadminPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("卡片信息修改成功！", "Eternia");
                } else if (res == 0) {
                    toastr["error"]("卡片信息修改失败！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");
    ...
    $("#leavPPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("留言设置修改成功！", "Eternia");
                } else if (res == 0) {
                    toastr["error"]("留言设置修改失败！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");
    ...
    $("#ImgAddPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("新增相册成功！", "Eternia");
                    $('#ImgUpdaPost').text('新增中...');
                    $("#ImgUpdaPost").attr("disabled", "disabled");
                    setInterval("window.location.href='loveimgset.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("新增相册失败！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");
    ...
    $("#listupda").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("修改事件成功！", "Eternia");
                    $('#listupda').text('修改中...');
                    $("#listupda").attr("disabled", "disabled");
                    setInterval("window.location.href='lovelist.php'", 1000);
                } else if (res == 0) {
                    toastr["error"]("修改事件失败！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");
    ...
    $("#aboutPost").click(function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res == 1) {
                    toastr["success"]("修改对话配置成功！", "Eternia");
                } else if (res == 0) {
                    toastr["error"]("修改对话配置失败！", "Eternia");
                }
            },
            error: function (err) {
                toastr["error"]("网络错误 请稍后重试！", "Eternia");

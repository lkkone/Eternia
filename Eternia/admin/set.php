        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="adminpost.php" method="post" onsubmit="return check()" novalidate>
                    ...
                    <div class="form-group">
                        <label for="validationCustom08">是否显示顶部横条</label>
                        <select class="form-control" id="example-select" name="headerBarShow">
                            <option value="1" <?php  if($diy['headerBarShow'] == "1"){ ?> selected <?php } ?>>显示</option>
                            <option value="2" <?php  if($diy['headerBarShow'] == "2"){ ?> selected <?php } ?> >隐藏</option>
                        </select>
                    </div>

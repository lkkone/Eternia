...
(1, 'Eternia', 'style/img/570374efdc2bb75a8b722c969118afb5.webp', 'Hi,欢迎你的来访', '愿得一人心白首不相离', '记录日常生活 留住感动', '听我介绍', '结束介绍', 'Eternia记录likaikai和laying的相伴时光', '把我们的日常与心动,轻轻放进时间里', '也欢迎每一位朋友留下溫暖的祝福', '你还记得第一次牵手的那天吗?', '要不要一起挑一首我们的主题曲?', '愿每次相望,时间都刚刚好', '为什么叫 Eternia?', '名字来自eternity(永恒)+ia', '意为我们的永恒之地', '把在一起的点滴安放在这里', '所以我们叫它 Eternia', '继续访问其他页面', '首页', '点点滴滴', '留言板', '关于', '欢迎您的来访 IP已记录请尽情浏览本站~');
...
(1, '<quote>引用内容样式</quote>\n\n<hr>\n\n\n<h1>H1文字大小演示</h1>\n\n<hr>\n\n\n<h2>H2文字大小演示</h2>\n\n<hr>\n\n\n<h3>H3文字大小演示</h3>\n\n<hr>\n\n\n<h4>H4文字大小演示</h4>\n\n<hr>\n\n\n<h5>H5文字大小演示</h5>\n\n<hr>\n\n\n<h6>H6文字大小演示</h6>\n\n<hr>\n\n\n<b>加粗字体</b>\n<s>删除线字体</s>\n<i>斜体</i>\n<code>强调内容</code>\n\n<center>文本居中</center>\n\n\n<!--分割线-->\n<hr>\n<quote>插入图片</quote>\n<img alt=\"\" src=\"style/img/WechatIMG42166.jpg\">\n<!--分割线-->\n<hr>\n<quote>插入视频</quote>\n\n<video src=\"style/video/42167_1762765879.mp4\" controls></video>\n\n<!--分割线-->\n<hr>', '2022-11-20', 'Eternia 默认文章语法', 'likaikai');
...
(1, 'likaikai', '1226530985', '默认留言', '1756830249', '223.104.79.236', '北京');
...
CREATE TABLE `login` (
  ...
  `pw` varchar(255) NOT NULL COMMENT '登录密码（支持 bcrypt 哈希）'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'admin', '$2y$10$TcY5rv4GA79K56WxbPxayOrcJlQ77MUSTsDczzaLrN./plK6ia16K');
...
(1, 'likaikai', 'aying', 'Eternia', 'Eternia {v5.2.0}', '爱晨雾漫过青瓦，爱暮色染透篱笆，更爱与君并肩立，看遍这人间烟火里的朝暮与年华。', '647159607', '917640289', '2022-02-12T10:00', '豫ICP备2025147784号', 'Copyright © 2025 Likaikai All Rights Reserved.', '点点滴滴', '留言板', '关于我们', '有人愿意听你碎碎念念也很浪漫', '在这里写下你的留言祝福', '我们之间的幸福回忆', 'style/img/bgCover.png', '1226530985', 'Ki', 1);
